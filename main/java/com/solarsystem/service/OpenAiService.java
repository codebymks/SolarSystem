...
import com.solarsystem.dto.ChatCompletionRequest;
import com.solarsystem.dto.ChatCompletionResponse;
import com.solarsystem.dto.MyResponse;
...
public class OpenAiService {
    ...
    public MyResponse makeRequest(String userPrompt, String _systemMessage) {
        ...
        try {
            ...
            logger.error("Error response status code: " + e.getStatusCode());
